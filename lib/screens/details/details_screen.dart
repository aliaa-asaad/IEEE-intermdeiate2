...
class MyApp extends StatelessWidget {
  ...
  /*
1.git add .
2. git commit 'الاسم -الحاجة اللي عملتها'
3.git pull origin main
لو في conflict بنحله الاول وبعدين نعمل الخطوات كلها من اول وجديد لما يقول الدنيا تمام بنروح لخطوة 4
4.git push origin اسم البرانش بتاع كل واحد
بعدها هتتنقل لبرانش الmain من كلمة main واللي جمبها سهم لو انت مش فيه وهيظهر فوق الcompare & pull request هنضغط عليها
git fetch
